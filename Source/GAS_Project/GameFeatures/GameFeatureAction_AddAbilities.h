...
class ULeeAbilitySet;

USTRUCT(BlueprintType)
struct FLeeAbilityGrant
{
	GENERATED_BODY()
...
class GAS_PROJECT_API UGameFeatureAction_AddAbilities : public UGameFeatureAction_WorldActionBase
{
	GENERATED_BODY()
public:
...
private:
	struct FActorExtensions
	{
		...
		TArray<FLeeAbilitySet_GrantedHandles> AbilitySetHandles;
	};
