...
UCLASS()
class GAS_PROJECT_API UAsyncAction_ExperienceReady : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
public:
	...
	void Step3_HandleExperienceLoaded(const class ULeeExperienceDefinition* CurrentExperience);
	void Step4_BroadcastReady();

	UPROPERTY(BlueprintAssignable)
	FExperienceReadyAsyncDelegate OnReady;

	TWeakObjectPtr<UWorld> WorldPrt;
};
