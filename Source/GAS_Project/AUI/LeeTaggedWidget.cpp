...
#include "LeeTaggedWidget.h"



ULeeTaggedWidget::ULeeTaggedWidget(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void ULeeTaggedWidget::NativeConstruct()
{
...
void ULeeTaggedWidget::NativeDestruct()
{
	if (!IsDesignTime())
	{
...
void ULeeTaggedWidget::SetVisibility(ESlateVisibility InVisibility)
{
...
void ULeeTaggedWidget::OnWatchedTagsChanged()
{
	const bool bHasHiddenTags = false;//@TODO: Foo->HasAnyTags(HiddenByTags);
