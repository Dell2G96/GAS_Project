...
#include "LeeTaggedWidget.generated.h"
...
class GAS_PROJECT_API ULeeTaggedWidget : public UCommonUserWidget
{
	GENERATED_BODY()

	
public:
	ULeeTaggedWidget(const FObjectInitializer& ObjectInitializer);
