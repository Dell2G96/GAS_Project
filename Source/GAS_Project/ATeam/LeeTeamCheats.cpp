...
void ULeeTeamCheats::CycleTeam()
{
	if (ULeeTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<ULeeTeamSubsystem>(GetWorld()))
	{
...
void ULeeTeamCheats::SetTeam(int32 TeamID)
{
	if (ULeeTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<ULeeTeamSubsystem>(GetWorld()))
	{
