...
#include "LeeVerbMessageHelpers.h"

#include "GameFramework/Pawn.h"
#include "GameFramework/PlayerController.h"
#include "GameFramework/PlayerState.h"
#include "GameplayEffectTypes.h"
#include "LeeVerbMessage.h"


FString FLeeVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FLeeVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
	return HumanReadableMessage;
}

class APlayerState* ULeeVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* ULeeVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
struct FGameplayCueParameters ULeeVerbMessageHelpers::VerbMessageToCueParameters(const FLeeVerbMessage& Message)
{
...
FLeeVerbMessage ULeeVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FLeeVerbMessage Result;
