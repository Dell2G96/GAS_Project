...
//
// #if WITH_EDITOR
// static TAutoConsoleVariable<bool> CVarApplyFrameRateSettingsInPIE(TEXT("Lee.Settings.ApplyFrameRateSettingsInPIE"),
// 	false,
// 	TEXT("Should we apply frame rate settings in PIE?"),
// 	ECVF_Default);
//
// static TAutoConsoleVariable<bool> CVarApplyFrontEndPerformanceOptionsInPIE(TEXT("Lee.Settings.ApplyFrontEndPerformanceOptionsInPIE"),
// 	false,
// 	TEXT("Do we apply front-end specific performance options in PIE?"),
// 	ECVF_Default);
//
// static TAutoConsoleVariable<bool> CVarApplyDeviceProfilesInPIE(TEXT("Lee.Settings.ApplyDeviceProfilesInPIE"),
// 	false,
...
// 	TEXT("Lee.DeviceProfile.Console.TargetFPS"),
// 	-1,
...
// 	TEXT("Lee.DeviceProfile.Console.FrameSyncType"),
// 	-1,
...
// 	TEXT("Lee.DeviceProfile.Mobile.DefaultFrameRate"),
// 	30,
...
// 	TEXT("Lee.DeviceProfile.Mobile.MaxFrameRate"),
// 	30,
...
// 	TEXT("Lee.DeviceProfile.Mobile.OverallQualityLimits"),
// 	TEXT(""),
...
// 	TEXT("Lee.DeviceProfile.Mobile.ResolutionQualityLimits"),
// 	TEXT(""),
...
// 	TEXT("Lee.DeviceProfile.Mobile.ResolutionQualityRecommendation"),
// 	TEXT("0:75"),
...
// //////////////////////////////////////////////////////////////////////
//
// FLeeScalabilitySnapshot::FLeeScalabilitySnapshot()
// {
...
// 	}
//
// 	void FillScalabilitySettingsFromDeviceProfile(FLeeScalabilitySnapshot& Mode, const FString& Suffix = FString())
// 	{
// 		static_assert(sizeof(Scalability::FQualityLevels) == 88, "This function may need to be updated to account for new members");
//
...
// 	{
// 		const ULeePlatformSpecificRenderingSettings* PlatformSettings = ULeePlatformSpecificRenderingSettings::Get();
...
// 			
// 			const bool bIsSupported = ULeeSettingsLocal::IsSupportedMobileFramePace(TestRate);
//
// 			return bAtOrBelowDesiredRate && bQualityDoesntExceedLimit && bIsSupported;
// 		});
//
// 		return PossibleRates.IsValidIndex(LimitIndex) ? PossibleRates[LimitIndex] : ULeeSettingsLocal::GetDefaultMobileFrameRate();
// 	}
//
...
// //////////////////////////////////////////////////////////////////////
//
// ULeeSettingsLocal::ULeeSettingsLocal()
// {
...
// 	}
//
// 	bEnableScalabilitySettings = ULeePlatformSpecificRenderingSettings::Get()->bSupportsGranularVideoQualitySettings;
//
// 	SetToDefaults();
// }
//
// void ULeeSettingsLocal::SetToDefaults()
// {
// 	Super::SetToDefaults();
//
...
// 	bEnableLatencyTrackingStats = ULeeSettingsLocal::DoesPlatformSupportLatencyTrackingStats();
//
// 	const ULeePlatformSpecificRenderingSettings* PlatformSettings = ULeePlatformSpecificRenderingSettings::Get();
...
// }
//
// void ULeeSettingsLocal::LoadSettings(bool bForceReload)
// {
// 	Super::LoadSettings(bForceReload);
//
// 	// Console platforms use rhi.SyncInterval to limit framerate
// 	const ULeePlatformSpecificRenderingSettings* PlatformSettings = ULeePlatformSpecificRenderingSettings::Get();
// 	if (PlatformSettings->FramePacingMode == ELeeFramePacingMode::ConsoleStyle)
// 	{
// 		FrameRateLimit = 0.0f;
// 	}
//
...
// 	DesiredUserChosenDeviceProfileSuffix = UserChosenDeviceProfileSuffix;
//
// 	LeeSettingsHelpers::FillScalabilitySettingsFromDeviceProfile(DeviceDefaultScalabilitySettings);
//
// 	DesiredMobileFrameRateLimit = MobileFrameRateLimit;
// 	ClampMobileQuality();
//
...
// }
//
// void ULeeSettingsLocal::ResetToCurrentSettings()
// {
...
// }
//
// void ULeeSettingsLocal::BeginDestroy()
// {
...
// }
//
// ULeeSettingsLocal* ULeeSettingsLocal::Get()
// {
// 	return GEngine ? CastChecked<ULeeSettingsLocal>(GEngine->GetGameUserSettings()) : nullptr;
// }
//
// void ULeeSettingsLocal::ConfirmVideoMode()
// {
...
// }
//
// float ULeeSettingsLocal::GetEffectiveFrameRateLimit()
// {
// 	const ULeePlatformSpecificRenderingSettings* PlatformSettings = ULeePlatformSpecificRenderingSettings::Get();
//
// #if WITH_EDITOR
...
// 	}
//
// 	if (PlatformSettings->FramePacingMode == ELeeFramePacingMode::DesktopStyle)
// 	{
...
// }
//
// int32 ULeeSettingsLocal::GetHighestLevelOfAnyScalabilityChannel() const
// {
// 	return LeeSettingsHelpers::GetHighestLevelOfAnyScalabilityChannel(ScalabilityQuality);
// }
//
// void ULeeSettingsLocal::OverrideQualityLevelsToScalabilityMode(const FLeeScalabilitySnapshot& InMode, Scalability::FQualityLevels& InOutLevels)
// {
// 	static_assert(sizeof(Scalability::FQualityLevels) == 88, "This function may need to be updated to account for new members");
//
...
// }
//
// void ULeeSettingsLocal::ClampQualityLevelsToDeviceProfile(const Scalability::FQualityLevels& ClampLevels, Scalability::FQualityLevels& InOutLevels)
// {
// 	static_assert(sizeof(Scalability::FQualityLevels) == 88, "This function may need to be updated to account for new members");
//
...
// }
//
// void ULeeSettingsLocal::OnExperienceLoaded()
// {
// 	ReapplyThingsDueToPossibleDeviceProfileChange();
// }
//
// void ULeeSettingsLocal::OnHotfixDeviceProfileApplied()
// {
// 	ReapplyThingsDueToPossibleDeviceProfileChange();
// }
//
// void ULeeSettingsLocal::ReapplyThingsDueToPossibleDeviceProfileChange()
// {
// 	ApplyNonResolutionSettings();
// }
//
// void ULeeSettingsLocal::SetShouldUseFrontendPerformanceSettings(bool bInFrontEnd)
// {
// 	bInFrontEndForPerformancePurposes = bInFrontEnd;
// 	UpdateEffectiveFrameRateLimit();
// }
//
// bool ULeeSettingsLocal::ShouldUseFrontendPerformanceSettings() const
// {
// #if WITH_EDITOR
...
// }
//
// ELeeStatDisplayMode ULeeSettingsLocal::GetPerfStatDisplayState(ELeeDisplayablePerformanceStat Stat) const
// {
// 	if (const ELeeStatDisplayMode* pMode = DisplayStatList.Find(Stat))
// 	{
// 		return *pMode;
// 	}
// 	else
// 	{
// 		return ELeeStatDisplayMode::Hidden;
// 	}
// }
//
// void ULeeSettingsLocal::SetPerfStatDisplayState(ELeeDisplayablePerformanceStat Stat, ELeeStatDisplayMode DisplayMode)
// {
// 	if (DisplayMode == ELeeStatDisplayMode::Hidden)
// 	{
...
// }
//
// bool ULeeSettingsLocal::DoesPlatformSupportLatencyMarkers()
// {
// 	return ICommonUIModule::GetSettings().GetPlatformTraits().HasTag(PerfStatTags::TAG_Platform_Trait_SupportsLatencyMarkers);
// }
//
// void ULeeSettingsLocal::SetEnableLatencyFlashIndicators(const bool bNewVal)
// {
...
// }
//
// void ULeeSettingsLocal::SetEnableLatencyTrackingStats(const bool bNewVal)
// {
...
// }
//
// void ULeeSettingsLocal::ApplyLatencyTrackingStatSetting()
// {
...
// }
//
// bool ULeeSettingsLocal::DoesPlatformSupportLatencyTrackingStats()
// {
// 	return ICommonUIModule::GetSettings().GetPlatformTraits().HasTag(PerfStatTags::TAG_Platform_Trait_SupportsLatencyStats);
// }
//
// float ULeeSettingsLocal::GetDisplayGamma() const
// {
// 	return DisplayGamma;
// }
//
// void ULeeSettingsLocal::SetDisplayGamma(float InGamma)
// {
// 	DisplayGamma = InGamma;
// 	ApplyDisplayGamma();
// }
//
// void ULeeSettingsLocal::ApplyDisplayGamma()
// {
// 	if (GEngine)
// 	{
...
// }
//
// float ULeeSettingsLocal::GetFrameRateLimit_OnBattery() const
// {
// 	return FrameRateLimit_OnBattery;
// }
//
// void ULeeSettingsLocal::SetFrameRateLimit_OnBattery(float NewLimitFPS)
// {
// 	FrameRateLimit_OnBattery = NewLimitFPS;
// 	UpdateEffectiveFrameRateLimit();
// }
//
// float ULeeSettingsLocal::GetFrameRateLimit_InMenu() const
// {
// 	return FrameRateLimit_InMenu;
// }
//
// void ULeeSettingsLocal::SetFrameRateLimit_InMenu(float NewLimitFPS)
// {
// 	FrameRateLimit_InMenu = NewLimitFPS;
// 	UpdateEffectiveFrameRateLimit();
// }
//
// float ULeeSettingsLocal::GetFrameRateLimit_WhenBackgrounded() const
// {
// 	return FrameRateLimit_WhenBackgrounded;
// }
//
// void ULeeSettingsLocal::SetFrameRateLimit_WhenBackgrounded(float NewLimitFPS)
// {
// 	FrameRateLimit_WhenBackgrounded = NewLimitFPS;
// 	UpdateEffectiveFrameRateLimit();
// }
//
// float ULeeSettingsLocal::GetFrameRateLimit_Always() const
// {
// 	return GetFrameRateLimit();
// }
//
// void ULeeSettingsLocal::SetFrameRateLimit_Always(float NewLimitFPS)
// {
// 	SetFrameRateLimit(NewLimitFPS);
// 	UpdateEffectiveFrameRateLimit();
// }
//
// void ULeeSettingsLocal::UpdateEffectiveFrameRateLimit()
// {
...
// }
//
// int32 ULeeSettingsLocal::GetDefaultMobileFrameRate()
// {
// 	return CVarDeviceProfileDrivenMobileDefaultFrameRate.GetValueOnGameThread();
// }
//
// int32 ULeeSettingsLocal::GetMaxMobileFrameRate()
// {
// 	return CVarDeviceProfileDrivenMobileMaxFrameRate.GetValueOnGameThread();
// }
//
// bool ULeeSettingsLocal::IsSupportedMobileFramePace(int32 TestFPS)
// {
...
// }
//
// int32 ULeeSettingsLocal::GetFirstFrameRateWithQualityLimit() const
// {
// 	return LeeSettingsHelpers::GetFirstFrameRateWithQualityLimit();
// }
//
// int32 ULeeSettingsLocal::GetLowestQualityWithFrameRateLimit() const
// {
// 	return LeeSettingsHelpers::GetLowestQualityWithFrameRateLimit();
// }
//
// void ULeeSettingsLocal::ResetToMobileDeviceDefaults()
// {
// 	// Reset frame rate
...
// }
//
// int32 ULeeSettingsLocal::GetMaxSupportedOverallQualityLevel() const
// {
// 	const ULeePlatformSpecificRenderingSettings* PlatformSettings = ULeePlatformSpecificRenderingSettings::Get();
// 	if ((PlatformSettings->FramePacingMode == ELeeFramePacingMode::MobileStyle) && DeviceDefaultScalabilitySettings.bHasOverrides)
// 	{
// 		return LeeSettingsHelpers::GetHighestLevelOfAnyScalabilityChannel(DeviceDefaultScalabilitySettings.Qualities);
// 	}
// 	else
// 	{
// 		return 3;
...
// }
//
// void ULeeSettingsLocal::SetMobileFPSMode(int32 NewLimitFPS)
// {
// 	const ULeePlatformSpecificRenderingSettings* PlatformSettings = ULeePlatformSpecificRenderingSettings::Get();
// 	if (PlatformSettings->FramePacingMode == ELeeFramePacingMode::MobileStyle)
// 	{
...
// }
//
// void ULeeSettingsLocal::SetDesiredMobileFrameRateLimit(int32 NewLimitFPS)
// {
...
// }
//
// void ULeeSettingsLocal::ClampMobileFPSQualityLevels(bool bWriteBack)
// {
// 	const ULeePlatformSpecificRenderingSettings* PlatformSettings = ULeePlatformSpecificRenderingSettings::Get();
// 	if (PlatformSettings->FramePacingMode == ELeeFramePacingMode::MobileStyle)
// 	{
// 		const int32 QualityLimit = LeeSettingsHelpers::GetApplicableOverallQualityLimit(DesiredMobileFrameRateLimit);
...
// }
//
// void ULeeSettingsLocal::ClampMobileQuality()
// {
// 	const ULeePlatformSpecificRenderingSettings* PlatformSettings = ULeePlatformSpecificRenderingSettings::Get();
// 	if (PlatformSettings->FramePacingMode == ELeeFramePacingMode::MobileStyle)
// 	{
...
// }
//
// void ULeeSettingsLocal::ClampMobileResolutionQuality(int32 TargetFPS)
// {
// 	// Clamp mobile resolution quality
// 	float MaxMobileResQuality = LeeSettingsHelpers::GetApplicableResolutionQualityLimit(TargetFPS);
...
// }
//
// void ULeeSettingsLocal::RemapMobileResolutionQuality(int32 FromFPS, int32 ToFPS)
// {
...
// 	float MaxScaleValue = 0.0f;
// 	GetResolutionScaleInformationEx(CurrentScaleNormalized, CurrentScaleValue, MinScaleValue, MaxScaleValue);
// 	float FromMaxMobileResQuality = LeeSettingsHelpers::GetApplicableResolutionQualityLimit(FromFPS);
// 	float ToMaxMobileResQuality = LeeSettingsHelpers::GetApplicableResolutionQualityLimit(ToFPS);
...
// }
//
// FString ULeeSettingsLocal::GetDesiredDeviceProfileQualitySuffix() const
// {
// 	return DesiredUserChosenDeviceProfileSuffix;
// }
//
// void ULeeSettingsLocal::SetDesiredDeviceProfileQualitySuffix(const FString& InDesiredSuffix)
// {
// 	DesiredUserChosenDeviceProfileSuffix = InDesiredSuffix;
// }
//
// void ULeeSettingsLocal::SetHeadphoneModeEnabled(bool bEnabled)
// {
...
// }
//
// bool ULeeSettingsLocal::IsHeadphoneModeEnabled() const
// {
// 	return bUseHeadphoneMode;
// }
//
// bool ULeeSettingsLocal::CanModifyHeadphoneModeEnabled() const
// {
// 	static IConsoleVariable* BinauralSpatializationDisabledCVar = IConsoleManager::Get().FindConsoleVariable(TEXT("au.DisableBinauralSpatialization"));
...
//
// 	const bool bBinauralSettingControlledByOS = LeeSettingsHelpers::HasPlatformTrait(TAG_Platform_Trait_BinauralSettingControlledByOS);
//
// 	return bHRTFOptionAvailable && !bBinauralSettingControlledByOS;
// }
//
// bool ULeeSettingsLocal::IsHDRAudioModeEnabled() const
// {
// 	return bUseHDRAudioMode;
// }
//
// void ULeeSettingsLocal::SetHDRAudioModeEnabled(bool bEnabled)
// {
...
// 		{
// 			if (ULeeAudioMixEffectsSubsystem* LeeAudioMixEffectsSubsystem = World->GetSubsystem<ULeeAudioMixEffectsSubsystem>())
// 			{
// 				LeeAudioMixEffectsSubsystem->ApplyDynamicRangeEffectsChains(bEnabled);
// 			}
// 		}
// 	}
// }
//
// bool ULeeSettingsLocal::CanRunAutoBenchmark() const
// {
// 	const ULeePlatformSpecificRenderingSettings* PlatformSettings = ULeePlatformSpecificRenderingSettings::Get();
// 	return PlatformSettings->bSupportsAutomaticVideoQualityBenchmark;
// }
//
// bool ULeeSettingsLocal::ShouldRunAutoBenchmarkAtStartup() const
// {
...
// }
//
// void ULeeSettingsLocal::RunAutoBenchmark(bool bSaveImmediately)
// {
...
// }
//
// void ULeeSettingsLocal::ApplyScalabilitySettings()
// {
// 	Scalability::SetQualityLevels(ScalabilityQuality);
// }
//
// float ULeeSettingsLocal::GetOverallVolume() const
// {
// 	return OverallVolume;
// }
//
// void ULeeSettingsLocal::SetOverallVolume(float InVolume)
// {
...
// }
//
// float ULeeSettingsLocal::GetMusicVolume() const
// {
// 	return MusicVolume;
// }
//
// void ULeeSettingsLocal::SetMusicVolume(float InVolume)
// {
// 	// Cache the incoming volume value
...
// }
//
// float ULeeSettingsLocal::GetSoundFXVolume() const
// {
// 	return SoundFXVolume;
// }
//
// void ULeeSettingsLocal::SetSoundFXVolume(float InVolume)
// {
// 	// Cache the incoming volume value
...
// }
//
// float ULeeSettingsLocal::GetDialogueVolume() const
// {
// 	return DialogueVolume;
// }
//
// void ULeeSettingsLocal::SetDialogueVolume(float InVolume)
// {
// 	// Cache the incoming volume value
...
// }
//
// float ULeeSettingsLocal::GetVoiceChatVolume() const
// {
// 	return VoiceChatVolume;
// }
//
// void ULeeSettingsLocal::SetVoiceChatVolume(float InVolume)
// {
// 	// Cache the incoming volume value
...
// }
//
// void ULeeSettingsLocal::SetVolumeForControlBus(USoundControlBus* InSoundControlBus, float InVolume)
// {
// 	// Check to see if references to the control buses and control bus mixes have been loaded yet
...
// }
//
// void ULeeSettingsLocal::SetAudioOutputDeviceId(const FString& InAudioOutputDeviceId)
// {
// 	AudioOutputDeviceId = InAudioOutputDeviceId;
// 	OnAudioOutputDeviceChanged.Broadcast(InAudioOutputDeviceId);
// }
//
// void ULeeSettingsLocal::ApplySafeZoneScale()
// {
// 	SSafeZone::SetGlobalSafeZoneScale(GetSafeZone());
// }
//
// void ULeeSettingsLocal::ApplyNonResolutionSettings()
// {
...
// }
//
// int32 ULeeSettingsLocal::GetOverallScalabilityLevel() const
// {
...
// }
//
// void ULeeSettingsLocal::SetOverallScalabilityLevel(int32 Value)
// {
...
// 		const int32 ConstrainedFrameRateLimit = LeeSettingsHelpers::ConstrainFrameRateToBeCompatibleWithOverallQuality(DesiredMobileFrameRateLimit, Value);
...
// }
//
// void ULeeSettingsLocal::SetControllerPlatform(const FName InControllerPlatform)
// {
...
// }
//
// FName ULeeSettingsLocal::GetControllerPlatform() const
// {
// 	return ControllerPlatform;
// }
//
// void ULeeSettingsLocal::LoadUserControlBusMix()
// {
// 	if (GEngine)
// 	{
// 		if (const UWorld* World = GEngine->GetCurrentPlayWorld())
// 		{
// 			if (const ULeeAudioSettings* LeeAudioSettings = GetDefault<ULeeAudioSettings>())
// 			{
...
// 				ControlBusMap.Empty();
//
// 				if (UObject* ObjPath = LeeAudioSettings->OverallVolumeControlBus.TryLoad())
// 				{
...
// 					else
// 					{
// 						ensureMsgf(SoundControlBus, TEXT("Overall Control Bus reference missing from Lee Audio Settings."));
// 					}
// 				}
//
// 				if (UObject* ObjPath = LeeAudioSettings->MusicVolumeControlBus.TryLoad())
// 				{
// 					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
// 					{
...
// 					else
// 					{
// 						ensureMsgf(SoundControlBus, TEXT("Music Control Bus reference missing from Lee Audio Settings."));
// 					}
// 				}
//
// 				if (UObject* ObjPath = LeeAudioSettings->SoundFXVolumeControlBus.TryLoad())
// 				{
// 					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
// 					{
...
// 					else
// 					{
// 						ensureMsgf(SoundControlBus, TEXT("SoundFX Control Bus reference missing from Lee Audio Settings."));
// 					}
// 				}
//
// 				if (UObject* ObjPath = LeeAudioSettings->DialogueVolumeControlBus.TryLoad())
// 				{
// 					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
// 					{
...
// 					else
// 					{
// 						ensureMsgf(SoundControlBus, TEXT("Dialogue Control Bus reference missing from Lee Audio Settings."));
// 					}
// 				}
//
// 				if (UObject* ObjPath = LeeAudioSettings->VoiceChatVolumeControlBus.TryLoad())
// 				{
// 					if (USoundControlBus* SoundControlBus = Cast<USoundControlBus>(ObjPath))
// 					{
...
// 					else
// 					{
// 						ensureMsgf(SoundControlBus, TEXT("VoiceChat Control Bus reference missing from Lee Audio Settings."));
// 					}
// 				}
//
// 				if (UObject* ObjPath = LeeAudioSettings->UserSettingsControlBusMix.TryLoad())
// 				{
...
// 					else
// 					{
// 						ensureMsgf(SoundControlBusMix, TEXT("User Settings Control Bus Mix reference missing from Lee Audio Settings."));
// 					}
// 				}
// 			}
// 		}
...
// }
//
// void ULeeSettingsLocal::OnAppActivationStateChanged(bool bIsActive)
// {
// 	// We might want to adjust the frame rate when the app loses/gains focus on multi-window platforms
// 	UpdateEffectiveFrameRateLimit();
// }
//
// void ULeeSettingsLocal::UpdateGameModeDeviceProfileAndFps()
// {
// #if WITH_EDITOR
...
//
// 	const ULeePlatformSpecificRenderingSettings* PlatformSettings = ULeePlatformSpecificRenderingSettings::Get();
// 	const TArray<FLeeQualityDeviceProfileVariant>& UserFacingVariants = PlatformSettings->UserFacingDeviceProfileOptions;
//
...
//
// 	int32 SuffixIndex = UserFacingVariants.IndexOfByPredicate([&](const FLeeQualityDeviceProfileVariant& Data){ return Data.DeviceProfileSuffix == UserChosenDeviceProfileSuffix; });
...
// 	if (GIsEditor)
// 	{
// 		const ULeePlatformEmulationSettings* Settings = GetDefault<ULeePlatformEmulationSettings>();
...
// 	{
// 	case ELeeFramePacingMode::MobileStyle:
// 		UpdateMobileFramePacing();
// 		break;
// 	case ELeeFramePacingMode::ConsoleStyle:
// 		UpdateConsoleFramePacing();
// 		break;
// 	case ELeeFramePacingMode::DesktopStyle:
// 		UpdateDesktopFramePacing();
// 		break;
// 	}
// }
//
// void ULeeSettingsLocal::UpdateConsoleFramePacing()
// {
...
// }
//
// void ULeeSettingsLocal::UpdateDesktopFramePacing()
// {
...
// }
//
// void ULeeSettingsLocal::UpdateMobileFramePacing()
// {
...
// }
//
// void ULeeSettingsLocal::UpdateDynamicResFrameTime(float TargetFPS)
// {
